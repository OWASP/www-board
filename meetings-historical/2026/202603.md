...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------- | ------------------------------------------------- |
| 1     | Send Board a summary after the developer/vendor meeting, including priorities and (if available) a firm delivery date.                           | Starr Brown / Team                                                    | After the meeting “today” (exact date not stated) |
| 2     | Confirm and communicate a hard delivery date for remaining community-facing website blockers and pen test remediation/validation.                | Starr Brown / Vendor / Staff                                          | Target to be set following the meeting “today”  |
| 3     | Reschedule the Board prep call after daylight savings/calendar issues settle to enable Ashwini to attend.                                        | Andrew van der Stock                                                       | When calendar stabilizes (date not stated) |
| 4     | Complete insurance renewal and provide certificates of insurance to requesting chapters.                                                         | Andrew van der Stock (and/or Treasurer/finance support)                    | Before beginning of April renewal date     |
| 5     | Adjust credit limits and transition recurring software/platform charges to appropriate corporate cards; resolve missing replacement card.        | Andrew van der Stock                                                       | As soon as practicable |
| 6     | Provide NDC trip report to the Board.                                                                                                            | Starr Brown                                                                       | By next Board meeting                             |
| 7     | Set up tracking and allocate owners for community policy reviews; resolve monday.com access/permissions issue (or choose alternate tool).        | Andrew van der Stock (with Christian)                                      | Date not stated |
| 8     | Distribute the latest budget spreadsheet to the Board (handling salary information appropriately) and update Meetup expense to full-year amount. | Andrew van der Stock / Finance team                                           | Before budget approval / as part of finalization |
