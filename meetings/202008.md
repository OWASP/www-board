...
The Executive Director initiated a Compliance Committee ruling on the result of the Richard Greenberg vote, in part to confirm that the vote is valid (it is), and what the minutes should say (see the motions in New Business), and if we need to formally adjourn the previous special meeting (we should). As a result, there are some motions for the Board to discuss and decide. 
