...
**Motion:** 
Motion to set up a program for developer community and developer engagement program. We work with developers to engage them to the security programs that OWASP currently has. This will be in the form of a Project.
