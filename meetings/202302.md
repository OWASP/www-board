...
#### Motion to approve travel policy

**Background** At the February 14, 2023 Board meeting, the Board approved a motion to change travel to be only economy airfares. This change needed to be reflected in various locations, so a new travel policy was created from the text in the staff handbook. The economy fare change has been included, and extended to bus and train fares as well. The policy is now ready for approval.

- [Travel Policy Pull Request](https://github.com/OWASP/www-policy/pull/128)

**Motion:** "Resolved, that the Board adopts the new OWASP travel policy and associated changes to other policies."
